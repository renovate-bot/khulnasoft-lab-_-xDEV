...
Now that you have proper logs, you can now [file issues with us](https://github.com/khulansoft-lab/patcher/issues). This is a reminder to include the following info:
