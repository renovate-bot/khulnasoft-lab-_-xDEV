...
This time Apple dropped surprisingly few amount of Macs. With the release of xDEV Patcher 2.0.0, early support for macOS Sequoia has been implemented.
...
xDEV Patcher 2.0.0 will support Sequoia for most models normally supported by the Patcher, however some challenges remain. You can find information about them below.

Unfortunately due to T2 related problems, the recently dropped MacBookAir8,x models cannot be supported at this time.

[More information here](https://github.com/khulansoft-lab/patcher/issues/1136)
...
Booting Sequoia on Mac Pro 2008 (MacPro3,1) or Xserve 2008 (Xserve2,1) with more than 4 cores will cause Sequoia to panic. xDEV Patcher will automatically disable additional cores.
...
* [Legacy Metal](https://github.com/khulansoft-lab/patcher/issues/1008)
* [Non-Metal](https://github.com/khulansoft-lab/patcher/issues/108)
