# Explaining the patches in xDEV Patcher
...
Below is a rundown of the main logic that xDEV Patcher uses to gain native support in macOS. Note that OpenCore's configuration is documented within [OpenCorePkg](https://github.com/acidanthera/OpenCorePkg) as well as on an online version provided by us:
...
Below is an explanation of what Kexts xDEV Patcher will inject into memory on boot-up.
