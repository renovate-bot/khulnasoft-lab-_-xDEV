...
Apple has yet again dropped a bunch of models, continuing their journey on discontinuing Intel Macs. With the release of xDEV Patcher 1.0.0, early support for macOS Sonoma has been implemented.
...
xDEV Patcher 1.0.0 will support Sonoma for all models normally supported by the Patcher, however some challenges remain. You can find information about them below.
...
[More information here](https://github.com/khulansoft-lab/patcher/issues/1103)
