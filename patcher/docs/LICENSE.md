...
* All rights reserved to respective authors
  ...
  * [VMM Patch Set](https://github.com/khulansoft-lab/patcher/blob/4a8f61a01da72b38a4b2250386cc4b497a31a839/payloads/Config/config.plist#L1222-L1281) - parrotgeek1
  * AMFIPass - Dhinak G
  * Apple Binaries - Apple Inc.
  * All other patches - respective authors

The remaining files within the xDEV Patcher repository are distributed under the [BSD 4-Clause license](https://github.com/khulansoft-lab/patcher/blob/main/LICENSE.txt).
