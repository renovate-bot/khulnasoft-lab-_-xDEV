...
If you're having issues with undetected internal disk, refer to [Internal disk missing when building OpenCore](https://dortania.github.io/Patcher/TROUBLESHOOTING.html#internal-disk-missing-when-building-opencore) for troubleshooting.
...
For more information on how to restore a Time Machine backup, [refer to the guide here.](https://dortania.github.io/Patcher/TIMEMACHINE.html)
...
Below entries represent GPUs no longer natively supported, ie. requiring root volume patching with xDEV Patcher:
