...
from patcher.volume  import generate_copy_arguments
from patcher.support import subprocess_wrapper
...
class GenerateApplication:
    ...
    def _generate_application(self) -> None:
        ...
        _args = self._pyinstaller + ["./OpenCore-GUI.spec", "--noconfirm"]
    ...
    def _embed_analytics_key(self) -> None:
        ...
        Embed analytics key
        """
        _file = Path("./patcher/support/analytics_handler.py")
