...
class ZSHFunctions:
    ...
    def generate_fix_settings_file_permission(self) -> str:
        ...
        _script += "    local settingsPath=\"$pathToTargetVolume/Users/Shared/.com.dortania.patcher.plist\"\n\n"
    ...
    def generate_clean_launch_service(self) -> str:
        ...
        _script += "    local domain=\"com.dortania.patcher\"\n\n"
...
class GenerateScripts:
    ...
    def __init__(self):
        ...
        self.files = [
            ...
            "Library/PrivilegedHelperTools/com.dortania.patcher.privileged-helper"
        ]

        self.additional_auto_pkg_files = [
            "Library/LaunchAgents/com.dortania.patcher.auto-patch.plist"
        ]
    ...
    def _generate_preinstall_script(self, is_autopkg: bool = False) -> str:
        ...
        _script += f"# {'AutoPkg Assets' if is_autopkg else 'xDEV Patcher'} Preinstall Script\n"
        _script += self._generate_header_bar()
    ...
    def _generate_postinstall_script(self, is_autopkg: bool = False) -> str:
        ...
        _script += self._generate_header_bar()
        _script += f"# {'AutoPkg Assets' if is_autopkg else 'xDEV Patcher'} Post Install Script\n"
        _script += self._generate_header_bar()
        if is_autopkg:
        ...
        _script += "helperPath=\"Library/PrivilegedHelperTools/com.dortania.patcher.privileged-helper\"\n"
    ...
    def _generate_uninstall_script(self) -> str:
        ...
        _script += self._generate_header_bar()
        _script += f"# xDEV Patcher Uninstall Script\n"
        _script += self._generate_header_bar()
        _script += "# Remove xDEV Patcher files and directories.\n"
        _script += self._generate_header_bar()
        _script += "\n\n"
