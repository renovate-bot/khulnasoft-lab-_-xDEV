...
class GeneratePackage:
    ...
    def __init__(self) -> None:
        ...
        self._files = {
            ...
            "./ci_tooling/privileged_helper_tool/com.dortania.patcher.privileged-helper": "/Library/PrivilegedHelperTools/com.dortania.patcher.privileged-helper",
        }
        self._autopkg_files = {
            "./payloads/Launch Services/com.dortania.patcher.auto-patch.plist": "/Library/LaunchAgents/com.dortania.patcher.auto-patch.plist",
        }
    ...
    def _generate_installer_welcome(self) -> str:
        ...
        _welcome += "# Overview\n"
        _welcome += f"This package will install the xDEV Patcher application (v{constants.Constants().patcher_version}) on your system."

        _welcome += "\n\nAdditionally, a shortcut for xDEV Patcher will be added in the '/Applications' folder."
        _welcome += "\n\nThis package will not 'Build and Install OpenCore' or install any 'Root Patches' on your machine. If required, you can run xDEV Patcher to install any patches you may need."
        _welcome += f"\n\nFor more information on xDEV Patcher usage, see our [documentation]({constants.Constants().guide_link}) and [GitHub repository]({constants.Constants().repo_link})."
        _welcome += "\n\n"
    ...
    def _generate_uninstaller_welcome(self) -> str:
        ...
        _welcome += "This package will uninstall the xDEV Patcher application and its Privileged Helper Tool from your system."
        _welcome += "\n\n"
        _welcome += "This will not remove any root patches or OpenCore configurations that you may have installed using xDEV Patcher."
        _welcome += "\n\n"
        _welcome += f"For more information on xDEV Patcher, see our [documentation]({constants.Constants().guide_link}) and [GitHub repository]({constants.Constants().repo_link})."
    ...
    def _generate_autopkg_welcome(self) -> str:
        ...
        _welcome += f"[xDEV Patcher GitHub Release]({constants.Constants().repo_link})"
    ...
    def generate(self) -> None:
        ...
        assert macos_pkg_builder.Packages(
            ...
            pkg_bundle_id="com.dortania.patcher-uninstaller",
            ...
            pkg_title="xDEV Patcher Uninstaller",
        ...
        assert macos_pkg_builder.Packages(
            ...
            pkg_bundle_id="com.dortania.patcher",
            pkg_version=constants.Constants().patcher_version,
