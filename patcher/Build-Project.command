...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Build xDEV Patcher Suite", add_help=False)
    ...
    if (args.run_as_individual_steps is False) or (args.run_as_individual_steps and args.prepare_application):
        ...
        sign_notarize.SignAndNotarize(
            path=Path("./ci_tooling/privileged_helper_tool/com.dortania.patcher.privileged-helper"),
