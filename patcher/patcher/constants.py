...
class Constants:
    def __init__(self) -> None:
        ...
        self.guide_link:                      str = "https://dortania.github.io/Patcher/"
        self.repo_link:                       str = "https://github.com/khulansoft-lab/patcher"
        self.installer_pkg_url:               str = f"{self.repo_link}/releases/download/{self.patcher_version}/AutoPkg-Assets.pkg"
        self.installer_pkg_url_nightly:       str = "http://nightly.link/khulansoft-lab/patcher/workflows/build-app-wxpython/main/AutoPkg-Assets.pkg.zip"
    ...
    def auto_patch_launch_agent_path(self):
        return self.launch_services_path / Path("com.dortania.patcher.auto-patch.plist")

    @property
    def rsr_monitor_launch_daemon_path(self):
        return self.launch_services_path / Path("com.dortania.patcher.rsr-monitor.plist")

    @property
    def update_launch_daemon_path(self):
        return self.launch_services_path / Path("com.dortania.patcher.macos-update.plist")

    @property
    def kdk_launch_daemon_path(self):
        return self.launch_services_path / Path("com.dortania.patcher.os-caching.plist")
