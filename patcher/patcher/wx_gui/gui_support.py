...
class GenerateMenubar:
    ...
    def generate(self) -> wx.MenuBar:
        ...
        aboutItem = fileMenu.Append(wx.ID_ABOUT, "&About xDEV Patcher")
...
class CheckProperties:
    ...
    def host_psp_version(self) -> packaging.version.Version:
        """
        Grab PatcherSupportPkg version from Patcher.plist
        """
        oclp_plist_path = "/System/Library/CoreServices/Patcher.plist"
