"""
updates.py: Check for xDEV Patcher binary updates
...
REPO_LATEST_RELEASE_URL: str = "https://api.github.com/repos/khulansoft-lab/patcher/releases/latest"
...
class CheckBinaryUpdates:
    ...
    def check_binary_updates(self) -> Optional[dict]:
        """
        Check if any updates are available for the xDEV Patcher binary
        ...
        for asset in data_set["assets"]:
            ...
            if asset["name"] == "OpenCore-Patcher.pkg":
                self.latest_details = {
                    ...
                    "Github Link": f"https://github.com/khulansoft-lab/patcher/releases/{latest_remote_version}",
                }
                return self.latest_details
