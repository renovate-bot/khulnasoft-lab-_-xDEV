"""
example_data.py: Sample Hardware probes, for use in xDEV Patcher validation
"""
...
class Macmini:
    ...
    Macmini71_Stock = device_probe.Computer(
        ...
        oclp_sys_url='https://github.com/khulansoft-lab/patcher/commit/daf28a62effb2ce06a71cb5961c9d0c79d72c16b',
        firmware_vendor='Apple',
        rosetta_active=False
    )
